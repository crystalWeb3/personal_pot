...
type: article
coverImage: https://res.cloudinary.com/noezectz/image/upload/v1653050141/Hiroshi/blog_at_cafe_ei1wf4.jpg
...
I've been always thinking about launching my own website with my custom domain name (**Hiroshi.dev**) since my college student life. But that never happened until this project. I've done several projects and works about web application development but I didn't make an effort to do this.
...
![searching Hiroshi.dev on google](https://res.cloudinary.com/noezectz/image/upload/v1648231400/Hiroshi/Hiroshi-on-google_asflq6.png "Hiroshi.dev is indexed")

Moreover, this website will be displayed well when shared to social media due to properly used meta tags.

![Hiroshi.dev card layout when shared to Facebook](https://res.cloudinary.com/noezectz/image/upload/v1653106955/Hiroshi/Hiroshi-dev-share-on-facebook_1_zjoehx.png "Card layout when shared to Facebook")
...
![Hiroshi.dev Lighthouse score](https://user-images.githubusercontent.com/53733092/159957822-7082e459-11e9-4616-8f1e-49d0881f7cbb.png "Hiroshi.dev Lighthouse score")
...
![animations at Hiroshi.dev](https://res.cloudinary.com/noezectz/image/upload/v1653108324/Hiroshi/ezgif.com-gif-maker_2_hehtlm.gif "Hiroshi.dev website")
...
- Website: [https://Hiroshi.dev/](https://Hiroshi.dev/ "https://Hiroshi.dev/")
- Blog: [https://Hiroshi.dev/blog](https://Hiroshi.dev/blog "https://Hiroshi.dev/blog")
