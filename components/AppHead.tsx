...
const AppHead: React.FC<Props> = ({
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/Hiroshi-blog-og.png`;
  let appOgImageAlt = "Hiroshi Tanaka's Blog";
