...
import Brandon from "../public/Brandon-illustration.png";
...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
       An Expert Blockchain & FullStack Engineer
      </span>
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="overflow-hidden">
          <span className="text-animation text-2xl md:text-3xl lg:text-5xl block md:my-3 text-marrsgreen dark:text-carrigreen font-medium">
            A Senior Blockchain & FullStack Developer
          </span>
        </div>
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
          Determined & goal-driven Blockchain & FullStack engineer specializing in TypeScript/Rust/Next/Nuxt/Node/Go/Solidity with an exceptional attention
        ...
        <LinkButton onClick={() => setIsModalOpen(true)}>Contact Me!</LinkButton>
      </div>
      <a
        href="#whoami"
